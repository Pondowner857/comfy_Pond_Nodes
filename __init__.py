...
from .nodes.Prompt_managerV2 import NODE_CLASS_MAPPINGS as Prompt_managerV2_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as Prompt_managerV2_DISPLAY_NAME_MAPPINGS
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    **Prompt_managerV2_DISPLAY_NAME_MAPPINGS,
